...
describe(constants.VAULT_CONTRACT_ID + ": Withdraw", function () {
    ...
    describe("Withdraw", function () {
        it("successful withdraw", async function () {
            ...
            await bondToken.connect(depositor).approve(vault.address, withdrawAmount);
        ...
        describe("Allowances", function () {
            it("withdrawing removes allowance", async function () {
                ...
                const allowanceBefore = parseInt(await bondToken.allowance(depositor.address, vault.address));
                expect(allowanceBefore).to.equal(amount)

                await vault.connect(depositor).withdraw(amount);

                //get allowance after 
                const allowanceAfter = parseInt(await bondToken.allowance(depositor.address, vault.address));
    ...
    describe("Events", function () {
        it("Withdraw event fires on withdraw", async () => {
            ...
            //approve
            await bondToken.connect(depositor).approve(vault.address, amountIn);
