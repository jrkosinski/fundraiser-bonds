...
module.exports = {
    ...
    TOKEN_NAME: "Fundraising Bond Token",
    TOKEN_SYMBOL: "FBT", 
    ...
    errorMessages: {
        ...
        VAULT_TOKEN_ONLY: "BondTokenOnly",
    ...
    exchangeRates: {
        PARITY: { bondToken: 1, baseToken: 1 },
        DEFAULT: { bondToken: 1, baseToken: 1 },
        ONE_PERCENT: { bondToken: 100, baseToken: 101 },
        TWO_PERCENT: { bondToken: 100, baseToken: 102 },
        ONE_COMP_2: { bondToken: 10000, baseToken: 10201 }, //one percent compounded twice 
        ONE_COMP_3: { bondToken: 1000000, baseToken: 1030301 }, //one percent compounded 3 times 
        ONE_COMP_4: { bondToken: 100000000, baseToken: 104060401 },   //one percent compounded 4 times 
        ONE_COMP_5: { bondToken: 100000000, baseToken: 105101005 },  //one percent compounded 5 times 
        ONE_COMP_6: { bondToken: 1000000000, baseToken: 1061520151 },  //one percent compounded 6 times 
        THREE_PERCENT: { bondToken: 100, baseToken: 103 },
        FIVE_PERCENT: { bondToken: 100, baseToken: 105 },
        TEN_PERCENT: { bondToken: 10, baseToken: 11 },
        NEG_ONE_PERCENT: { bondToken: 100, baseToken: 99 },

        onePercentCompounding: [
            { bondToken: 1, baseToken: 1 },
            { bondToken: 100, baseToken: 101 },
            { bondToken: 10000, baseToken: 10201 },
            { bondToken: 1000000, baseToken: 1030301 },
            { bondToken: 100000000, baseToken: 104060401 },
            { bondToken: 10000000000, baseToken: 10510100501 },
            { bondToken: 1000000000000, baseToken: 1061520150601 },
            { bondToken: 100000000000000, baseToken: 107213535210701 },
            { bondToken: 10000000000000000, baseToken: 10828567056280802 },
            { bondToken: 10000000000000000, baseToken: 10936852726843610 },
            { bondToken: 10000000000000000, baseToken: 11046221254112046 },
            { bondToken: 10000000000000000, baseToken: 11156683466653166 },
            { bondToken: 10000000000000000, baseToken: 11268250301319698 },
            { bondToken: 10000000000000000, baseToken: 11380932804332894 },
            { bondToken: 10000000000000000, baseToken: 11494742132376222 },
            { bondToken: 10000000000000000, baseToken: 11609689553699984 }
        ]
    }
};
