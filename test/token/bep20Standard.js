...
describe(constants.TOKEN_CONTRACT_ID + ": BEP20 Standard Adherence", function () {
    ...
    describe("BEP20 Compliance", function () {
        ...
        it("transfer zero amount to non-vault address is allowed", async function () {
        ...
        //skipped because user transfer is disabled 
        it("transferFrom zero amount to non-vault address is allowed", async function () {
        ...
        it("transfer to non-vault address must emit Transfer event", async function () {
            await expectEvent(
        ...
        it("transferFrom to non-vault address must emit Transfer event", async function () {
            await token.approve(addr1.address, 10);
            await expectEvent(
